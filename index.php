<?php
$sections = [
        ['id'=> 1,'name' => 'Backend','thumb' => 'static/pic/section_1.jpg'],
        ['id'=> 2,'name' => 'Frontend','thumb' => 'static/pic/section_2.jpg'],
        ['id'=> 3,'name' => 'Database','thumb' => 'static/pic/section_3.jpg'],
        ['id'=> 4,'name' => 'UI','thumb' => 'static/pic/section_4.jpg'],
]
?>
<!DOCTYPE html>
<html lang="zh-CN">
            ...
            <div class="wrap">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="slider">
                                <img src="static/pic/slide_1.jpg" alt="轮播图">
                            </div>
                            <div class="primary">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="block_header">
                                                    ...
                                                    <a class="more" href="<section.php?sid=<?=$section['id']?>">more</a>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <ul class="list">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="image">
                                                    <img src="<?=$section['thumb']?>" alt="Backend">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
